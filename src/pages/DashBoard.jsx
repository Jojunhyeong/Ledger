...
export default function DashBoard() {
  ...
  const stats = [
    { id: 1, title: '이번 달 수입', amount: totalsCurr.income, rate: fmtPct(incomeRate), type: 'income' },
    { id: 2, title: '이번 달 지출', amount: totalsCurr.expense, rate: fmtPct(expenseRate), type: 'expense' },
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-10 gap-4 md:mt-8 mt-4">
        {stats.map((s) => (
          <StatCard
            key={s.id}
            title={s.title}
